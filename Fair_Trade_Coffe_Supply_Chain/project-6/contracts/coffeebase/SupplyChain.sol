...
contract SupplyChain {
  ...
  modifier checkValue(uint _upc) {
    _;
    //items[_upc].consumerID = payable(items[_upc].consumerID);
  ...
  function harvestItem(uint _upc, address payable _originFarmerID, string memory _originFarmName, string memory _originFarmInformation, string memory _originFarmLatitude, string memory _originFarmLongitude, string memory _productNotes) public 
  {
    ...
    Item memory newItem = Item({sku: sku, upc: _upc, ownerID: msg.sender, originFarmerID: _originFarmerID, originFarmName: _originFarmName, originFarmInformation: _originFarmInformation, originFarmLatitude: _originFarmLatitude, originFarmLongitude: _originFarmLongitude, productID: upc + sku, productNotes: _productNotes, productPrice: 0, itemState: defaultState, distributorID: address(0), retailerID: address(0), consumerID: address(0)});
    items[sku] = newItem;
  ...
  function buyItem(uint _upc) payable public
    // Call modifier to check if upc has passed previous supply chain stage
    forSale(_upc)
